...
public class ModelGuardian extends ModelBase {
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn)
    {
        ...
        EntityLivingBase entityLivingBase = (EntityGuardian)entityIn;
        ...
        Entity entity = getViewRenderEntity();
        ...
        {
        	Vec3 vec3 = entityLivingBase.getPosition(0.0F);
            Vec3 vec31 = entityLivingBase.getPosition(0.0F);
            double d0 = vec3.yCoord - vec31.yCoord;
            double d1 = vec3.xCoord - vec31.xCoord;
            ...
            Vec3 vec32 = entityLivingBase.getLook(0.0F);
            vec32 = new Vec3i(vec32.xCoord, 0.0D, vec32.zCoord);
            Vec3 vec33 = new Vec3i(d1, 0.0D, d2).normalize();
            double d11 = vec32.dotProduct(vec33);
            this.guardianEye.rotationPointX = MathHelper.sqrt_float((float)Math.abs(d11)) * 2.0F * (float)Math.signum(d11);
    ...
    private Vec3 createVectorHelper(double d1, double d, double d2) {
    	return new Vec3i(d1, d, d2);
	}
    
    
    

	public Entity getViewRenderEntity()
    {
        return this.minecraft.getMinecraft().renderViewEntity;
    }
}
